      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1">Hello I'm <br/> <span className="text-accent">Mario Iskander</span></h1>
            <p className="max-w-[500px] mb-9 mt-5 text-white/80">
              An experienced software developer for crafting elegant digital solutions with proficiency in various programming languages and technologies.
            </p>
